...
module Trds
  class Invoice
    ...
    embeds_many :freights,     class_name: "Trds::InvoiceFreight",   inverse_of: :doc_inv, cascade_callbacks: true
    has_many    :dlns,         class_name: "Trds::DeliveryNote",     inverse_of: :doc_inv
    has_many    :grns,         class_name: "Trds::Grn",              inverse_of: :doc_inv
    has_many    :pyms,         class_name: "Trds::Payment",          inverse_of: :doc_inv, dependent: :delete
    belongs_to  :client,       class_name: "Trds::PartnerFirm",      inverse_of: :invs_client
    belongs_to  :client_d,     class_name: "Trds::PartnerFirmPerson",inverse_of: :invs_client
    belongs_to  :signed_by,    class_name: "Trds::User",             inverse_of: :invs
    ...
    # @todo
    def increment_name
      firm = Trds::PartnerFirm.find_by(:firm => true)
      invs = Trds::Invoice.yearly(Date.today.year).nonin
      if invs.count > 0
  ...
  class InvoiceFreight < Trst::Freight
    ...
    embedded_in :doc_inv, class_name: "Trds::Invoice",  inverse_of: :freights
  end # InvoiceFreight
end # Trds
