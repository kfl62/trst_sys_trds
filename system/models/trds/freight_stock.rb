...
module Trds
  class FreightStock < Trst::FreightStock
    ...
    belongs_to  :freight,     class_name: 'Trds::Freight',              inverse_of: :stks, index: true
    belongs_to  :unit,        class_name: 'Trds::PartnerFirm::Unit',    inverse_of: :fsts, index: true
    belongs_to  :doc_stk,     class_name: 'Trds::Stock',                inverse_of: :freights, index: true
