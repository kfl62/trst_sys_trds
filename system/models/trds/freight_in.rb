...
module Trds
  class FreightIn < Trst::FreightIn
    ...
    belongs_to  :freight,     class_name: 'Trds::Freight',              inverse_of: :ins, index: true
    belongs_to  :unit,        class_name: 'Trds::PartnerFirm::Unit',    inverse_of: :ins, index: true
    belongs_to  :doc_grn,     class_name: 'Trds::Grn',                  inverse_of: :freights, index: true
    belongs_to  :doc_sor,     class_name: 'Trds::Sorting',              inverse_of: :resl_freights, index: true
