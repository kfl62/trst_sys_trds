...
module Trds
  class Sorting < Trst::Sorting
    ...
    has_many   :from_freights, class_name: "Trds::FreightOut",          inverse_of: :doc_sor, dependent: :destroy
    has_many   :resl_freights, class_name: "Trds::FreightIn",           inverse_of: :doc_sor, dependent: :destroy
    belongs_to :unit,          class_name: "Trds::PartnerFirm::Unit",   inverse_of: :srts
    belongs_to :signed_by,     class_name: "Trds::User",                inverse_of: :srts
